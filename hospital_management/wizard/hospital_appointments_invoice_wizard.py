    ...
    def create_invoice(self):
        ...
        for active_id in active_ids: 
            ...
            if lab_req.no_invoice == False:
                ...
                'type': 'out_invoice',
                'ref': False,
                'partner_id': lab_req.patient_id.id or False,
                'partner_shipping_id':False,
                # 'currency_id':lab_req.patient_id.currency_id.id ,
                'currency_id':False,
                'invoice_payment_term_id': False,
                # 'fiscal_position_id': lab_req.patient_id.property_account_position_id.id,
                'fiscal_position_id': False,
                'team_id': False,
                'invoice_date': date.today(),
                # 'company_id':lab_req.patient_id.company_id.id or False ,
                'company_id': False ,
                }
